...
namespace Dan.Demo
{
    ...
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.RunningLeaderboard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        {
            Leaderboards.RunningLeaderboard.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.RunningLeaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
